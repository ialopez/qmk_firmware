...
[SYMB] = LAYOUT_gergoplex(
    ...
    KC_SPC, KC_SPC,  KC_SPC, KC_SPC, KC_SPC,   KC_MINS, KC_EQL, KC_SLSH, KC_LCBR, KC_RCBR,
    KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_SPC,   KC_UNDS, KC_PLUS,  KC_PIPE, KC_LBRC,  KC_RBRC,
 ...
 * |-----+-----+-----+-----+------+		   |-------------------------------|
 * |  F6  | F7  | F8  | F9  | F10 |      |MLFT | MDWN| MUP | MRGT|j VOLDN |
 * `------+-----+-----+------+----'		   `-------------------------------'
 *  				.-----------------.           .-----------------.   
 *  				| F11 | F12|	  	|						|     | PLY | SKP |
 *  				'-----------------'           '-----------------' 
